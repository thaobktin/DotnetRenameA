...
#Region " Methods "
        ...
        Public Shared Sub SetDefault()
            Dim fullMode = New Dictionary(Of String, String) From _
                                       {{"ChbNamespacesRP", "1"}, _
                                        {"ChbTypesRP", "1"}, _
                                        {"ChbMethodsRP", "1"}, _
                                        {"ChbRenameParametersMethods", "1"}, _
                                        {"ChbRenameVariablesMethods", "1"}, _
                                        {"ChbPropertiesRP", "1"}, _
                                        {"ChbEventsRP", "1"}, _
                                        {"ChbFieldsRP", "1"}, _
                                        {"ChbAttributesRP", "1"}, _
            ...
            Cls_IniFile.INIWrite(iniPath, modeName(1), "ChbRenameParametersMethods", "0")
            Cls_IniFile.INIWrite(iniPath, modeName(1), "ChbRenameVariablesMethods", "0")
            ...
            Cls_IniFile.INIWrite(iniPath, modeName(1), "ChbResourcesRP", "1")
        ...
        Public Shared Function GetConfig(iMode%) As Cls_RenamerState
            Dim _paramArgs As New Cls_RenamerState() With { _
                                                    ...
                                                    .Parameters = CBool(Cls_IniFile.INIRead(iniPath, GetStrMode(iMode), "ChbRenameParametersMethods")), _
                                                    .Variables = CBool(Cls_IniFile.INIRead(iniPath, GetStrMode(iMode), "ChbRenameVariablesMethods")), _
                                                    ...
                                                    .ResourcesContent = CBool(Cls_IniFile.INIRead(iniPath, GetStrMode(iMode), "ChbResourcesRP")), _
